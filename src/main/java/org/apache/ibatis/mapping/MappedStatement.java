...
/**
 * @author Clinton Begin Mybatis 框架的核心类之一，它存储了一个 sql 对应的所有信息
 */
public final class MappedStatement {
  ...
  // 当前MappedStatement的唯一识别ID，并且在同一个Configuration中是唯一的它由Mapper类的完全限定名和Mapper方法名称拼接而成
  private String id;
  ...
  // StatementType枚举有：STATEMENT, PREPARED, CALLABLE,默认值是：PREPARED
  private StatementType statementType;
  // 结果集处理类型，决定了结果集游标的移动方式(只能向前移动、双向移动且对修改敏感、双向移动对修改不敏感)
